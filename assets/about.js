...
var texts = [document.getElementById('text-1'),document.getElementById('text-2'),document.getElementById('text-3'),document.getElementById('text-4'),document.getElementById('text-5'),document.getElementById('text-6'),document.getElementById('text-7'),document.getElementById('text-8'),document.getElementById('text-9')];
